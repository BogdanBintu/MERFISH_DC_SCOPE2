...
#cd "C:\Users\Scope3\ScriptsScope3\MERFISH_SCOPE2\Analysis_1500gns_MERFISH"&&activate cellpose&&python workerScope3.py
...
def main_f(set_ifov):
    save_folder =r'\\192.168.0.10\bbfishdc13\DCBBL1_3_15_2023__GFP\MERFISH_Analysis'
    if not os.path.exists(save_folder): os.makedirs(save_folder)
    all_flds = glob.glob(r'\\192.168.0.10\bbfishdc13\DCBBL1_3_15_2023__GFP\P*_set1')
    all_flds += glob.glob(r'\\192.168.0.10\bbfishdc13\DCBBL1_3_15_2023__GFP\H*_set1')

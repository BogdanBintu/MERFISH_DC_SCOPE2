#cd C:\Users\Scope3\ScriptsScope3\MERFISH_SCOPE2\smFISHAnalysisHuman && activate cellpose && python worker_smFISH__DCBB_human__03_23_2023.py "_C" 50 "H4_"
from multiprocessing import Pool, TimeoutError
import time,sys
import os,sys
from tqdm import tqdm
master_analysis_folder = r'C:\Users\Scope3\ScriptsScope3\MERFISH_SCOPE2\smFISHAnalysisHuman' #Scope3Microscope
...
def f(set_ifov_iQs=None):
    if True:
        ...
        try:
            asm = analysis_smFISH(data_folders = [r'T:\DCBB_human__03_23_2023'],
                     save_folder =r'T:\DCBB_human__03_23_2023_Analysis',
                     H0folder=  r'T:\DCBB_human__03_23_2023\H0_*',exclude_H0=True)
